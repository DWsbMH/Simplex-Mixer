 ...
 */ = (function() {
  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
      ...
      peg$c17 = function(constraint) {
        return addMatrixRow();
      },
      peg$c18 = function(variableName) {
        isExistingVariable(variableName);
      },
      peg$c19 = "*",
      peg$c20 = peg$literalExpectation("*", false),
      peg$c21 = function(multiplier) {
        tmp.push(parseFloat(multiplier));
      },
      peg$c22 = /^[0-9]/,
      ...
      peg$c27 = function(sign) {
        return sign;
      },
      peg$c28 = /^[+\-]/,
      peg$c29 = peg$classExpectation(["+", "-"], false, false),
      peg$c30 = function(constraint) {
        constraints.push(parseFloat(constraint));
      },
      peg$c31 = "min",
    ...
    function isExistingVariable(actualVar) {
      ...
      if (variables.includes(actualVar)) {
        ...
        throw new SyntaxError(
          actualVar + " variable doesn't exist. You can use only: " + variables
        );
      }
      return returnValue;
    }
    ...
    function addMatrixRow() {
      if (aMatrix[0] != undefined && aMatrix[0].length != tmp.length) {
        throw new SyntaxError(
          "Number of variables should be equal to variables of the first expression"
        );
      }
      aMatrix.push(tmp);
      tmp = [];
